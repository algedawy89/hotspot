Config({
    "network-name": "السعيدة",
    "service-number": "772024038",
    "login-type": "passwordAsUser",
    "news-line": " <span style='color:rgb(61, 43, 31)'>.::</span>  تنوية : لقد تم اضافة استراحة للشبكة (  <span style='background:white;color:red;border-radius:12px;'>بث مباشر</span> - مسلسلات - افلام - برامج تلفزيونية - اسلاميات)   <span style='color:rgb(61, 43, 31);margin:0px 2px' >e.net</span>  <span style='color:rgb(61, 43, 31)'>::.</span> " ,
    ...
    "sell-points": [
        ...
        {"name":"النعطي للمعسل "},
        {"name":"بقالة مالك"},
        {"name":"بقالة اشرف الملحم"},
        {"name":"بقالة سعيد"},
        {"name":"بقالة محمد سعيد"},
        {"name":"بيت المزاج للمعسل"}
