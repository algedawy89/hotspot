...
function loanSuccess(a){var b=document.getElementById("loan");setTimeout(function(){b.classList.remove("active");b.style.display="none"},500);onLoggedIn(a);$loanButton.classList.remove("processing")}function tryLoan(a){console.log(a);if(!isLoggedIn(a))return loanError(a);var b=parseInt(a.session_time_left_secs);if(999999999123<parseInt(a.remain_bytes_total)+parseInt(a.bytes_in)){if(isTryLoan)return loanError(a);setTimeout(function(){loanRequest(tryLoan);isTryLoan=!0},1E3*b)}else loanSuccess(a)}
function loanRequest(a){var b=isTryLoan?"/status?var=callBack":"/login?username=T-".concat($loginData.mac,"&var=callBack"),c=new XMLHttpRequest;c.open("GET",b,!0);c.onreadystatechange=function(){if(4===this.readyState){var d=this.responseText;try{var e=JSON.parse(d);void 0!==a&&a(e)}catch(f){showErrorPopup(),$loanButton.classList.remove("processing")}}};c.send()}
